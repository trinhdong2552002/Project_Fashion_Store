...
$(document).ready(function () {
  ...
  function loadmenu() {
    var content = `<a class="nav-link" href="index">
    ...
    var menu = `<nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
  ...
  function loadtop() {
    var top = `<a class="navbar-brand ps-3" href="index">Quản trị hệ thống</a>
